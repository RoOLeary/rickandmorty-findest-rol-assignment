...
describe('CharacterCard Component', () => {
  ...
  it('renders character details correctly', () => {
    ...
    expect(screen.getByText(/Species:/i)).toHaveTextContent('Human');
    expect(screen.getByText(/Status:/i)).toHaveTextContent('Alive');
    expect(screen.getByText(/Origin:/i)).toHaveTextContent('Earth');
    expect(screen.getByText(/Location:/i)).toHaveTextContent('Earth');
