...
jest.mock("../../../components/Characters", () => () => (
  <div data-testid="characters-content">Characters Component</div>
));
jest.mock("../../../components/Locations", () => () => (
  <div data-testid="locations-content">Locations Component</div>
));
jest.mock("../../../components/Episodes", () => () => (
  <div data-testid="episodes-content">Episodes Component</div>
));
